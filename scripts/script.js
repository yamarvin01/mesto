...
const cardTemplate = document.querySelector("#card-template").content; //Можно удалить позже
...
class Card {
  ...
  _handleCardLikeClick() {
    this._element.querySelector('.card__button_type_like').classList.toggle("card__button_status_active");
  }
